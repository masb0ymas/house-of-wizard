...
export const metadata: Metadata = {
  ...
  description: 'Privacy Policy House of Wizard',
}
      ...
      <div className="flex flex-col gap-4 mt-10">
        ...
        <div className="space-y-2 mb-4">
          ...
          <ul className="pl-8 list-disc">
            ...
            <li>
              With Affiliates: In cases where we collaborate with partner organizations for
              co-branded courses or webinars.
            </li>
          </ul>
        </div>
        ...
        <div className="space-y-2 mb-4">
          ...
          <ul className="pl-8 list-disc">
            <li>
              Access and Update: You may review and update your personal information by contacting
              us.
            </li>
            <li>
        ...
        <div className="space-y-2 mb-4">
          <h4 className="text-xl font-semibold font-serif tracking-wide">5. Security Measures</h4>
          <p>
            We implement industry-standard measures to protect your data, including encryption,
            secure storage, and regular audits. However, no method of online transmission is 100%
            secure, and we cannot guarantee absolute security.
          </p>
        </div>

        <div className="space-y-2 mb-4">
          <h4 className="text-xl font-semibold font-serif tracking-wide">6. Third-Party Links</h4>
          <p>
        ...
        <div className="space-y-2 mb-4">
          ...
          <p>
            We retain your data for as long as necessary to provide our services or comply with
            legal obligations.
          </p>
        </div>

        <div className="space-y-2 mb-4">
          <h4 className="text-xl font-semibold font-serif tracking-wide">8. International Users</h4>
          <p>
            If you access our services from outside Indonesia, your data may be transferred to and
            processed in Indonesia, where privacy laws may differ.
          </p>
        </div>
        ...
        <div className="space-y-2 mb-4">
          <h4 className="text-xl font-semibold font-serif tracking-wide">10. Contact Us</h4>
          <p>
