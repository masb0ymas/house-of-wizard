 ...
 *
 * @return {React.ReactElement} The Terms of Service page component.
 */
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="flex flex-col gap-4 mt-10">
        ...
        <Separator />
        <h4 className="text-2xl font-semibold font-serif tracking-wide">1. Definitions</h4>
        <p>
          “We,” “us,” “our” refer to <b>House of Wizard</b>, the provider of the services. “User,”
          “you,” “your” refer to individuals accessing or using our services. “Services” include the
          website, webinars, online courses, and associated materials provided by us.
        </p>
        <Separator />
        <h4 className="text-2xl font-semibold font-serif tracking-wide">2. Eligibility</h4>
        <p>
          You must be at least 18 years old to use our services. If you are under 18, you must have
          parental or guardian consent.
        </p>
        <Separator />
        <h4 className="text-2xl font-semibold font-serif tracking-wide">3. User Accounts</h4>
        ...
        <Separator />
        <h4 className="text-2xl font-semibold font-serif tracking-wide">4. Payment and Refunds</h4>
        ...
        <Separator />
        <h4 className="text-2xl font-semibold font-serif tracking-wide">6. Prohibited Conduct</h4>
        ...
        <h4 className="text-2xl font-semibold font-serif tracking-wide">7. Disclaimers</h4>
        ...
        <h4 className="text-2xl font-semibold font-serif tracking-wide">9. Privacy Policy</h4>
        <p>
        ...
        <h4 className="text-2xl font-semibold font-serif tracking-wide">10. Termination</h4>
        <p>
        ...
        <h4 className="text-2xl font-semibold font-serif tracking-wide">11. Governing Law</h4>
        <p>
        ...
        <h4 className="text-2xl font-semibold font-serif tracking-wide">12. Changes to Terms</h4>
        <p>
        ...
        <h4 className="text-2xl font-semibold font-serif tracking-wide">13. Contact Us</h4>
        <p>
          If you have questions about these Terms, please contact us at{' '}
          <Link href="/contact">contact</Link>. By using our services, you acknowledge that you have
