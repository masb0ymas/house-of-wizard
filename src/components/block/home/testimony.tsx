    ...
    <section id="testimonials" className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative overflow-hidden">
          ...
          <div className="pointer-events-none absolute inset-y-0 left-0 w-1/3 bg-linear-to-r from-gray-50 dark:from-background"></div>
          <div className="pointer-events-none absolute inset-y-0 right-0 w-1/3 bg-linear-to-l from-gray-50 dark:from-background"></div>
        </div>
      </div>
    </section>
  )
