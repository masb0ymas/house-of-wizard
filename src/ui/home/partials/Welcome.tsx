...
export default function Welcome() {
  ...
  function web2Welcome() {
    ...
    if (!check_attendance && _.isEmpty(queryAttendance.data?.id)) {
      return (
        <>
          <Text size="lg">To become a great wizard, connect your wallet first.</Text>
  ...
  return isWeb3 ? web3Welcome() : web2Welcome()
}
