...
export default function TermPage() {
  ...
  return (
    <div className="relative overflow-hidden bg-linear-to-br from-slate-50 via-white to-amber-50 py-24 sm:py-28">
            ...
            <aside className="space-y-6">
              <div className="rounded-lg border border-slate-200/70 bg-white/90 p-6 shadow-xs">
                ...
                <ul className="mt-4 space-y-3 text-slate-600">
                  <li>
                    <span className="font-semibold text-slate-800">Responsible access:</span> 18+
                    learners or guardian-approved participation.
                  </li>
                  <li>
                    <span className="font-semibold text-slate-800">Educational focus:</span> our
                    insights are guidance, not guarantees.
                  </li>
                  <li>
                    <span className="font-semibold text-slate-800">Intellectual property:</span>{' '}
